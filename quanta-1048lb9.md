---
layout: default
title: Ryu Certification - /quanta-1048lb9
---
...
| |Required|IPv4|IPv6|ARP|
|-----------|----|----|----|----|
|[IN_PORT](https://github.com/osrg/ryu/tree/master/ryu/tests/switch/of13/match/00_IN_PORT.json)|x | [OK](#676630805778c633439bbf5baeeb1fc3) / [ERROR](#676630805778c633439bbf5baeeb1fc3) / [ERROR](#676630805778c633439bbf5baeeb1fc3) | [ERROR](#676630805778c633439bbf5baeeb1fc3) / [ERROR](#676630805778c633439bbf5baeeb1fc3) / [ERROR](#676630805778c633439bbf5baeeb1fc3) | [ERROR](#676630805778c633439bbf5baeeb1fc3) / [ERROR](#676630805778c633439bbf5baeeb1fc3) / [ERROR](#676630805778c633439bbf5baeeb1fc3) |
...
..........
    2Mbps(ethernet/ipv4(src=random,dst=random)/tcp(src_port=random,dst_port=random))-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 201.55kbps, {'in_port': 3} 208.97kbps
..........
    2Mbps(ethernet/ipv6(src=random,dst=random)/tcp(src_port=random,dst_port=random))-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 2031.88kbps, {'in_port': 3} 58.98kbps
..........
    2Mbps(ethernet/arp(src_ip=random,dst_ip=random)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 576.09kbps, {'in_port': 3} 586.64kbps
</pre>
...
<pre>
    2Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:1Mbps(drop),output:2'                            ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDrop(burst_size=13,len=16,rate=1000,type=1)] != [OFPMeterBandDrop(burst_size=0,len=16,rate=1000,type=1)])
...
<pre>
    20Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:10Mbps(drop),output:2'                          ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDrop(burst_size=13,len=16,rate=10000,type=1)] != [OFPMeterBandDrop(burst_size=0,len=16,rate=10000,type=1)])
...
<pre>
    200Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:100Mbps(drop),output:2'                        ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDrop(burst_size=13,len=16,rate=100000,type=1)] != [OFPMeterBandDrop(burst_size=0,len=16,rate=100000,type=1)])
...
<pre>
    2Mbps(ethernet/ipv4(dscp=18)/tcp)-->'in_port=1,actions=meter:1Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDscpRemark(burst_size=13,len=16,prec_level=1,rate=1000,type=2)] != [OFPMeterBandDscpRemark(burst_size=0,len=16,prec_level=1,rate=1000,type=2)])
...
<pre>
    20Mbps(ethernet/ipv4(dscp=18)/tcp)-->'in_port=1,actions=meter:10Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDscpRemark(burst_size=13,len=16,prec_level=1,rate=10000,type=2)] != [OFPMeterBandDscpRemark(burst_size=0,len=16,prec_level=1,rate=10000,type=2)])
...
<pre>
    200Mbps(ethernet/ipv4(dscp=18)/tcp)-->'in_port=1,actions=meter:100Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDscpRemark(burst_size=13,len=16,prec_level=1,rate=100000,type=2)] != [OFPMeterBandDscpRemark(burst_size=0,len=16,prec_level=1,rate=100000,type=2)])
